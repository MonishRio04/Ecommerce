...
#logo img{
  ...
  <nav>
    ...
    <div class="container">
      ...
      <img class="product-image" src="data:image/jpeg;base64,'.$encimage.'">
      <div class="product-info">
        <div class="product-title">'.$row['product'].'</div>
        <div class="product-price">
        <i class="fa fa-inr"></i>'.$row['price'].'</div>
        ...
        <a href="cbuynow.php?id='. $row['id'] .'"class="btn btn-danger">Buy now</a>'
        ?><?php endif;?><br>
    </div>
    </div>
  </body>
