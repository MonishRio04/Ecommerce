...
<body>
     <nav>
        ...
        <form method="post" action="">
            ...
            <li><button type="submit"><i class="fa fa-search"></i></a></li>
    </form>
          </ul>
        </nav>
        <?php
        ...
        ?>
          <?php
           ...
           <?php $sql="SELECT * FROM images WHERE product LIKE '%{$row['product']}%';";
           ...
           '?>
          <?php endwhile; 
           $sql1 = "SELECT * FROM laptops WHERE product LIKE '%$search%' OR color LIKE '%$search%' OR price LIKE '%$search%' 
           OR specification LIKE '%$search%'";
           ...
           '?>
          <?php endwhile; 
           $sql2 = "SELECT * FROM cameras WHERE product LIKE '%$search%' OR color LIKE '%$search%' OR price LIKE '%$search%' 
           OR specification LIKE '%$search%'";
